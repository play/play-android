 ...
 */
public class UnstarSongTask extends AsyncTask<Song, Void, IOException> {

	private static final String TAG = "UnstarSongTask";
	 ...
	 * @param service
	 */
	public UnstarSongTask(final AtomicReference<PlayService> service) {
